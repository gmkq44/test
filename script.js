...
const personalities = {
    "ISTJ": { name: "小小检查员", desc: "你做事认真、有条理，是大家信赖的可靠伙伴。" },
    "ISFJ": { name: "温暖守护者", desc: "你心地善良，乐于助人，总是默默地关心着身边的每一个人。" },
    "INFJ": { name: "神秘小先知", desc: "你有很强的直觉，能理解别人的感受，心里充满了奇思妙想。" },
    "INTJ": { name: "智慧小军师", desc: "你聪明、有远见，喜欢思考复杂的问题，总能想出绝妙的计划。" },
    "ISTP": { name: "动手小能手", desc: "你充满好奇心，喜欢亲手探索和修理东西，动手能力一级棒。" },
    "ISFP": { name: "创意小画家", desc: "你热爱美好事物，有独特的艺术天赋，能创造出美丽的作品。" },
    "INFP": { name: "治愈梦想家", desc: "你内心世界丰富，充满爱与善意，像童话里的小天使。" },
    "INTP": { name: "思维小侦探", desc: "你总是在思考“为什么”，喜欢分析和研究，是天生的逻辑大师。" },
    "ESTP": { name: "活力冒险家", desc: "你精力充沛，勇敢爱挑战，是小伙伴中的带头“玩家”。" },
    "ESFP": { name: "快乐表演家", desc: "你阳光开朗，喜欢成为焦点，能给身边的人带来无穷的欢乐。" },
    "ENFP": { name: "闪光小精灵", desc: "你热情、有创意，对世界充满好奇，总能发现生活中的乐趣。" },
    "ENTP": { name: "机智小发明家", desc: "你脑子转得飞快，点子多多，喜欢和别人辩论和交流新想法。" },
    "ESTJ": { name: "可靠小队长", desc: "你有出色的组织能力，做事果断，是天生的领导者。" },
    "ESFJ": { name: "贴心小主人", desc: "你热情好客，善于交际，总能让每个人都感到受欢迎。" },
    "ENFJ": { name: "引路小导师", desc: "你有感染力，能鼓励和引导他人，是大家的人生小导师。" },
    "ENTJ": { name: "天生小领袖", desc: "你自信、有魄力，目标明确，能带领大家一起完成伟大的事情。" }
};
